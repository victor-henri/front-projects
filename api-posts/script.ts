const menuButton = document.getElementsByClassName('nav-mb')[0] as HTMLElement;
const menuInterface = document.getElementsByClassName('nav-dt')[0] as HTMLElement;
const exitButton = document.getElementsByClassName('exit')[0] as HTMLElement;
const articlesMain = document.getElementsByClassName('articles')[0] as HTMLElement;
